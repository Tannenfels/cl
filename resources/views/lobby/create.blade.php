...
@section('content')
    ...
    <form action="{{ route('lobby.store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Настройки карты:</strong>
                    По приглашениям?<input type="checkbox" name="is_hidden" value="true">
                    Эталонный режим?<input type="checkbox" name="is_etalon_mode" value="true">
                </div>
            </div>
